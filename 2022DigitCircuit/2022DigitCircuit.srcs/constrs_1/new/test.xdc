...
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { segments[0] }]; #IO_L23P_T3_FOE_B_15 Sch=segments[0]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { segments[1] }]; #IO_L23N_T3_FWE_B_15 Sch=segments[1]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { segments[2] }]; #IO_L24P_T3_A01_D17_14 Sch=segments[2]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { segments[3] }]; #IO_L19P_T3_A22_15 Sch=segments[3]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { segments[4] }]; #IO_L8N_T1_D12_14 Sch=segments[4]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { segments[5] }]; #IO_L14P_T2_SRCC_14 Sch=segments[5]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { segments[6] }]; #IO_L23P_T3_35 Sch=segments[6]
# set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { segments[7] }]; #IO_L23N_T3_A02_D18_14 Sch=segments[7]
